 ...
 <div class="container-fluid">
    ...
    <div class="col-xl-6 col-md-6 mb-6">
        <div class="card border-left-success shadow h-100 py-2">
            ...
            <div class="text">All staffs will be automatically promoted base on these criterias<?php //echo htmlentities($result->question);?></div>
            ...
            <input type="hidden" name="q_id" value="<?php //echo htmlentities($result->q_id); ?>">
                <a  href="procriterias.php" type="submit" class="btn btn-success">Get started</a>
        ...
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                <form action="answer.php" method="get">
            <div class="name"><h3><b>Promotion short listed</b></h3></div>
            <hr>
            
            <div class="text">Total number of short listed staffs:</div>
            <div class="date"><?php //echo htmlentities($result->date_ask);?></div>
            <hr>
            <div class="text">Officers for promotion:</div>
            <div class="date"><?php //echo htmlentities($result->date_ask);?></div>
            <hr>
            <input type="hidden" name="q_id" value="<?php //echo htmlentities($result->q_id); ?>">
                <a  href="proShortlisted.php" type="submit" class="btn btn-success">Get started</a>
