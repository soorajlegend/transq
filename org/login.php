...
if (isset($_POST['submit'])){
  ...
  $query="SELECT * FROM organisation WHERE email='$login_id' AND password='$password'";
...
<div class="container">
    <div class="row py-5 mt-4 align-items-center">
        ...
        <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
            ...
            <p class="font-italic text-muted mb-0">Create account to get access to Qualified employers free of curruption</p>
        </div>
        ...
        <div class="col-md-7 col-lg-6 ml-auto">
            ...
            <?php echo $pass_error; ?>
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="email" type="email" name="login_id" placeholder="Email Address" class="form-control bg-white border-left-0 border-md">
                    </div>
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="lastName" type="password" name="password" placeholder="Password" class="form-control bg-white border-left-0 border-md">
                    </div>
