...
<button class="my3d-btn"><i class="fa fa-question"></i>Question</button>
<button class="my3d-btn"><i class="fa fa-inbox"></i>Recieve</button>
<button class="my3d-btn"><i class="fa fa-share"></i>Share</button>
<button class="my3d-btn"><i class="fa fa-heart"></i>Follow</button>
                </div>
