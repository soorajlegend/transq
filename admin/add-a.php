...
if (strlen($_SESSION['user_id'] == 0)) {
    ...
    if(isset($_POST['submit']))
    {
     $msg="";
      ...
      $query=mysqli_query($con, "insert into users(name,password,login_id,user_status) value('$name','$password','$login_id','1')");
      if ($query) {
...
<?php include 'topbar.php';?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Register New Admin</h1>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Register New Admin</h6>
